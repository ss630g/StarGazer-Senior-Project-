...
public class weatherpowerup : MonoBehaviour
{
    ...
    public Button SecondCityButton;
    public Button ThirdCityButton;
    public Button ClosePanelButton;
    public Text seasonText1;
    public Text seasonText2;
    public Text seasonText3;
    public string [] cities ={"New York", "Mumbai", "Tianjin" , "Moscow", "Denver", "Los Angeles", "Tokyo", "Dhaka", "Istanbul", "Karachi", "Beijing",
    "Shanghai", "Singapore", "Dudinka", "Harbin"};
    public string city1;
    public string city2;
    public string city3;
   //[SerializeField] private panel customPanel;
    void Start()
    {
        ...
        FirstCityButton.onClick.AddListener(CityLocation1);
        SecondCityButton.onClick.AddListener(CityLocation2);
        ThirdCityButton.onClick.AddListener(CityLocation3);
    ...
    void getcity() {
        ...
        int index2 = rand.Next(0,13);
        int index3 = rand.Next(0,13);
        city1 = cities[index];
        city2 = cities[index2];
        city3 = cities[index3];
        //return city;
